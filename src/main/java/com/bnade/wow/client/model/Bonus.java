...
public class Bonus implements Comparable<Bonus> {
	...
	static {
		...
		bonusIds.add(567);
		// 7.0 新物品
		bonusIds.add(1457);	// 835
		bonusIds.add(1462);	// 840
		bonusIds.add(1467);	// 845
		bonusIds.add(1472);	// 850
		...
		// 1127新增
		bonusIds.add(1612);	// 820
		bonusIds.add(1617);	// 825
		bonusIds.add(1622);	// 830
		bonusIds.add(1627);	// 835
		bonusIds.add(1632);	// 840
		bonusIds.add(1637);	// 845
