			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<div class="col-md-10">
					...
					<ul>
						...
						<li>支付宝最近的红包活动，扫一扫领红包，每天一次，这几天还有大额的专属红包</li>
						<li><img alt="支付宝红包" src="/images/zfbhb_sm.png"/></li>
						<li>第2天之前如果红包没有用掉，可以考虑<a href="/donate.jsp">打赏一下</a>小站哦，打赏页面->支付宝支付->红包打赏,所有的红包赏金将在打赏页面公布，感谢所有的朋友</li>
					</ul>
				</div>
				<div class="col-md-2">
