	...
	!function(){
		...
		$.get("wow/auction/realms/summary", function(data) {
       		if (data.length === 0) {
       			...
       			var tblHtml = "<table class='table table-striped table-condensed'><thead><tr><th>#</th><th>服务器</th><th>类型</th><th>拍卖总数量</th><th>拍卖行玩家数</th><th>物品种类</th><th>更新时间</th></tr></thead><tbody>";
       			for (var i in data) {
